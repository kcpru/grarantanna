...
public class TutorialBrain : MonoBehaviour
{
    ...
    {
        "Witaj w NAZWA_GRY. W tej prostej grze chodzi o to, aby dostać się do drzwi. Jednak, abyś był w stanie je otworzyć, potrzebujesz zdobyć do nich klucz. Ale po koleji... Do poruszania się użyj ASD lub strzałek na klawiaturze. Aby biec szybciej, przytrzymaj lewy lub prawy Shift.",
