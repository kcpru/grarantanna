...
public class TutorialBrain : MonoBehaviour
{
    ...
    {
        "Witaj w NAZWA_GRY. W tej prostej grze chodzi o to, aby dostać się do drzwi. Jednak, abyś był w stanie je otworzyć, potrzebujesz zdobyć do nich klucz. Ale po koleji... Do poruszania się użyj ASD lub strzałek na klawiaturze. Aby biec szybciej, przytrzymaj lewy lub prawy Shift. Jeśli spotkasz na swojej drodze przeciwników, uderz ich mieczem za pomocą lewego lub prawego Controla.",
        "Dobrze. Jeśli chcesz podskoczyć, naciśnij W lub Spację. Spróbuj.",
        "Jak widzisz poruszanie się jest bardzo proste. Teraz pora na coś bardziej zaawansowanego. W naszej grze znajduje się kilka przedmiotów, które mają za zadanie urozmaicić rozgrywkę. Stoisz własnie przed paroma z nich. Przycisk, który widzisz można aktywować stając na nim lub wpychając na niego jakiś przedmiot. Wówczas otworzy on jakąś bramę.",
